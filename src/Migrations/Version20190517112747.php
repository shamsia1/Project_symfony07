 ...
 */
final class Version20190517112747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articlle ADD category_id INT NOT NULL');
        $this->addSql('ALTER TABLE articlle ADD CONSTRAINT FK_9ACB3F7012469DE2 FOREIGN KEY (category_id) REFERENCES categori (id)');
        $this->addSql('CREATE INDEX IDX_9ACB3F7012469DE2 ON articlle (category_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_9ACB3F7012469DE2 ON articlle');
        $this->addSql('ALTER TABLE articlle DROP category_id');
    }
}
